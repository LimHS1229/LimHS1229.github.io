...
layout: page
title: Houdini Agent
permalink: /HoudiniAgent/
---

{% assign houdini_agent_posts = site.posts | where_exp: "post", "post.path contains 'HoudiniAgent/_posts/'" | sort: "date" | reverse %}

{% if houdini_agent_posts.size > 0 %}
{% for post in houdini_agent_posts %}
...
{% endfor %}
{% else %}
No posts found in `HoudiniAgent/_posts`.
{% endif %}
