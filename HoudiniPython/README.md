...
permalink: /HoudiniPython/
---

{% assign houdini_python_posts = site.posts | where_exp: "post", "post.path contains 'HoudiniPython/_posts/'" | sort: "date" | reverse %}

{% if houdini_python_posts.size > 0 %}
{% for post in houdini_python_posts %}
...
{% endfor %}
{% else %}
No posts found in `HoudiniPython/_posts`.
{% endif %}
